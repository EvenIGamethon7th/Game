...
{
    public class UI_SlicedFilledImage : MaskableGraphic, ISerializationCallbackReceiver, ILayoutElement, ICanvasRaycastFilter
    {
...
#pragma warning restore 1692
        ...
        protected UI_SlicedFilledImage()
        {
...
#if UNITY_2017_4 || UNITY_2018_2_OR_NEWER
        private static List<UI_SlicedFilledImage> m_TrackedTexturelessImages = new List<UI_SlicedFilledImage>();
        ...
        private static void RebuildImage(SpriteAtlas spriteAtlas)
        {
            ...
            {
                UI_SlicedFilledImage image = m_TrackedTexturelessImages[i];
